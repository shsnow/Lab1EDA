...
public class MaxPQ<Key> implements Iterable<Key> {
  ...
  public static ArrayList<String> print3(MaxPQ<quintupla> pq){
        int tmn = pq.size();
        ArrayList<String> tres = new ArrayList<String>();  
        while(!pq.isEmpty())
        {
            if(pq.size() <4 || pq.size()> tmn-3){
            
            tres.add(pq.delMax().get_producto());
            }else{
            pq.delMax();
            }
        }
    ...
    public void insert(Key x) {
     ...
     public void sort(ArrayList<quintupla> a ){

   MaxPQ<quintupla> pq = new MaxPQ<quintupla>();
        for(quintupla tr : pq){
    ...
    ***************************************************************************/
    ...
    {   
        ...
        quintupla[] data;
        data = new quintupla[7];
        quintupla t1;
        
        quintupla t2, t3, t4, t5, t6, t7;
        t1 = new quintupla("A", "B", 6);
        t2 = new quintupla("A", "C", 4);
        t3 = new quintupla("B", "A", 10);
        t4 = new quintupla("B", "C", 1);
        t5 = new quintupla("B", "D", 21);
        t6 = new quintupla("D", "F", 17);
        t7 = new quintupla("R", "X", 13);
       /* pq.insert(t1);
        pq.insert(t2);
        pq.insert(t3);
        pq.insert(t4);
