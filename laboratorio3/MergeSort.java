...
public class MergeSort{
    ...
    private ArrayList<quintupla> inArr;
    
    public ArrayList<quintupla> getSortedArray() {
        return inArr;
    }
 
    public MergeSort(ArrayList<quintupla> inArr){
        this.inArr = inArr;
    }
    ...
    public void merger(int l,int m,int r){
        ...
        ArrayList<quintupla> mergesortArr = new ArrayList<quintupla>();
